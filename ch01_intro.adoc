...
documento titulado “Bitcoin: Un sistema de efectivo electrónico peer-to-peer”, escrito bajo el seudónimo de Satoshi Nakamoto (ver <<satoshi_whitepaper>>). Nakamoto combinó varios inventos previos, como las firmas digitales y Hashcash, para crear un sistema de efectivo electrónico completamente descentralizado que no depende de una autoridad central para la emisión de la moneda ni para la liquidación y validación de las transacciones.  

[[satoshi_whitepaper]]  
**VER Satoshi white paper**:: https://bitcoin.org/files/bitcoin-paper/bitcoin_es_latam.pdf
